CREATE TABLE  IF NOT EXISTS  IF NOT EXISTS  IF NOT EXISTS  IF NOT EXISTS  IF NOT EXISTS  IF NOT EXISTS [dbo].[cache] (
...
CREATE TABLE  IF NOT EXISTS [dbo].[cache_shared] (
...
CREATE TABLE  IF NOT EXISTS [dbo].[cache_index] (
	[user_id] [int] NOT NULL ,
...
CREATE TABLE  IF NOT EXISTS [dbo].[cache_thread] (
	[user_id] [int] NOT NULL ,
	[mailbox] [varchar] (128) COLLATE Latin1_General_CS_AS NOT NULL ,
	[expires] [datetime] NULL ,
	[data] [text] COLLATE Latin1_General_CI_AI NOT NULL 
...
CREATE TABLE  IF NOT EXISTS [dbo].[cache_messages] (
	[user_id] [int] NOT NULL ,
	[mailbox] [varchar] (128) COLLATE Latin1_General_CS_AS NOT NULL ,
	[uid] [int] NOT NULL ,
	[expires] [datetime] NULL ,
...
CREATE TABLE  IF NOT EXISTS [dbo].[collected_addresses] (
...
CREATE TABLE  IF NOT EXISTS [dbo].[contacts] (
...
CREATE TABLE  IF NOT EXISTS [dbo].[contactgroups] (
...
CREATE TABLE  IF NOT EXISTS [dbo].[contactgroupmembers] (
...
CREATE TABLE  IF NOT EXISTS [dbo].[identities] (
...
CREATE TABLE  IF NOT EXISTS [dbo].[dictionary] (
	[user_id] [int] ,
...
CREATE TABLE  IF NOT EXISTS [dbo].[searches] (
...
CREATE TABLE  IF NOT EXISTS [dbo].[filestore] (
